...
const QUERIES = {
  ...
  imoveis: { cols: 35, sql: (n) => `INSERT INTO imoveis (id,codigo,titulo,tipo_mae,tipo_imovel,locacao_venda,endereco,numero,complemento,compl_blocos,unidade_imovel,quadra,lote,cep,bairro,cidade,estado,dormitorios,suites,banheiros,area_util,area_total,valor,valor_locacao,edificio_id,data_cadastro,data_atualizacao,observacoes,dado_proprietario,v_dado_proprietario,descricao,observacoes_locacao,corretor_id,situacao_codigo_venda,situacao_codigo_locacao) VALUES ${n} ON CONFLICT (id) DO UPDATE SET valor=EXCLUDED.valor,valor_locacao=EXCLUDED.valor_locacao,titulo=EXCLUDED.titulo,locacao_venda=EXCLUDED.locacao_venda,observacoes=EXCLUDED.observacoes,dado_proprietario=EXCLUDED.dado_proprietario,v_dado_proprietario=EXCLUDED.v_dado_proprietario,descricao=EXCLUDED.descricao,observacoes_locacao=EXCLUDED.observacoes_locacao,corretor_id=EXCLUDED.corretor_id,data_atualizacao=EXCLUDED.data_atualizacao,endereco=EXCLUDED.endereco,numero=EXCLUDED.numero,complemento=EXCLUDED.complemento,compl_blocos=EXCLUDED.compl_blocos,unidade_imovel=EXCLUDED.unidade_imovel,quadra=EXCLUDED.quadra,lote=EXCLUDED.lote,cep=EXCLUDED.cep,bairro=EXCLUDED.bairro,cidade=EXCLUDED.cidade,estado=EXCLUDED.estado,situacao_codigo_venda=EXCLUDED.situacao_codigo_venda,situacao_codigo_locacao=EXCLUDED.situacao_codigo_locacao` },
